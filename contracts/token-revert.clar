;; token-revert
;; A secure token transaction reversal mechanism on the Stacks blockchain
;; This contract provides advanced token transfer controls and emergency revocation
;; capabilities for protecting users from unauthorized or erroneous transactions.
;; Error Constants
